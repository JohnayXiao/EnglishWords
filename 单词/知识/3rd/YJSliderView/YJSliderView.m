...
- (void)layoutSubviews {
    ...
    //背景色
//    self.contentCollectionView.backgroundColor = RGBCOLOR(161, 223, 205);
...
- (void)setUpLabels {
    ...
    for (NSInteger index = 0; index < [self.delegate numberOfItemsInYJSliderView:self]; index ++) {
        ...
        label.font = mediumFontWithSize(14);
...
- (UICollectionView *)titleCollectionView {
    ...
    if ( totalNum <= 6) {
        ...
        topLayout.itemSize = CGSizeMake(self.frame.size.width / 6, topViewHeight);
    }
